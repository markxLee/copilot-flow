...
| `/deep-dive` | Optional deep dive option A/B (A: Copilot-only; B: external LLM API) |
...
| `.github/prompts/deep-dive.prompt.md` | Optional deep dive option A/B (A: Copilot-only; B: external LLM API) |
